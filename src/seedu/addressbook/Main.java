...
public class Main {
    ...
    private TextUi ui;
    private Formatter formatOutput;
    ...
    private void start(String[] launchArgs) {
        try {
            this.ui = new TextUi();
            this.formatOutput = new Formatter();
            this.storage = initializeStorage(launchArgs);
            this.addressBook = storage.load();
            formatOutput.showWelcomeMessage(VERSION, storage.getPath());
    ...
    private CommandResult executeCommand(Command command)  {
        try {
            ...
            formatOutput.showToUser(e.getMessage());
            throw new RuntimeException(e);
        }
    }
